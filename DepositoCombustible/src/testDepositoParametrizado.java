...
public class testDepositoParametrizado {
...
private double resultado;
	 ...
	 public testDepositoParametrizado (double ni, double cm , double cr, double res ) {
		 nivelInicial=ni;
		 capacidadMaxima=cm;
		 cantidadRelleno=cr;
		 resultado=res;
	...
	public static Collection<Object[]> valores(){
		 return Arrays.asList(new Object[][]{
			 {30.0,50.0,15.0,15.0},{40.0,50.0,20.0,20.0},{15.0,50.0,-20.0,0.0}
